...
LSH_MATMUL_SRCS = $(wildcard lsh_matmul/cc/kernels/lsh_matmul.cc) $(wildcard lsh_matmul/cc/ops/lsh_matmul_op.cc)

LSH_MATMUL_GRAD_SRCS = $(wildcard lsh_matmul/cc/kernels/lsh_matmul_grad.cc) $(wildcard lsh_matmul/cc/ops/lsh_matmul_grad_op.cc)
...
LSH_MATMUL_GRAD_TARGET_LIB = lsh_matmul/python/ops/lsh_matmul_grad.so
...
lsh_matmul_test: lsh_matmul/python/ops/lsh_matmul_op_test.py lsh_matmul/python/ops/lsh_matmul_op.py $(LSH_MATMUL_TARGET_LIB) $(LSH_MATMUL_GRAD_TARGET_LIB)
